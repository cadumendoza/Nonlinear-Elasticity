function [x_equil,iflag,iter,Ener] = Equilibrate(x,options,spring,K,iload)
...
switch options.method
  case 0,   %vanilla Newton-Raphson
    ...
    err_x=100;
    err_f=100;
    [Ener,grad_E,Hess_E] = Ener_short(x_short,3,spring,K,iload);
  ...
  case 1,   % Newton-Raphson with line search
    ...
    while (iter<=options.n_iter_max) & ...
      ...
      if options.linesearch==1
          ...
          [x_short, t]=LineSearch(x_short,dx,Ener,direction,options,spring,K,iload);
      else
          t=1;
          x_short=x_short+dx;
      end
